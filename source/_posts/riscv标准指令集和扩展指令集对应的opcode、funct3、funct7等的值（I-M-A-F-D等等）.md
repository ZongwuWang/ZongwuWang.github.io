---
title: riscv标准指令集和扩展指令集对应的opcode、funct3、funct7等的值（I/M/A/F/D等等）
password: www
...
![](./riscv标准指令集和扩展指令集对应的opcode、funct3、funct7等的值（I-M-A-F-D等等）/2022-03-01-18-53-17.png)

![](./riscv标准指令集和扩展指令集对应的opcode、funct3、funct7等的值（I-M-A-F-D等等）/2022-03-01-18-53-34.png)

![](./riscv标准指令集和扩展指令集对应的opcode、funct3、funct7等的值（I-M-A-F-D等等）/2022-03-01-18-53-59.png)

![](./riscv标准指令集和扩展指令集对应的opcode、funct3、funct7等的值（I-M-A-F-D等等）/2022-03-01-18-54-14.png)

![](./riscv标准指令集和扩展指令集对应的opcode、funct3、funct7等的值（I-M-A-F-D等等）/2022-03-01-18-54-34.png)

## 方法2 查阅riscv的github库

网上找了好久都没找到，后来才发现github的riscv-tools库中有所有指令的opcode……

Github链接：[riscv-tools](https://github.com/riscv/riscv-opcodes/blob/7c3db437d8d3b6961f8eb2931792eaea1c469ff3/opcodes)、[riscv-opcode](https://github.com/riscv/riscv-opcodes)

![](./riscv标准指令集和扩展指令集对应的opcode、funct3、funct7等的值（I-M-A-F-D等等）/2022-03-01-18-50-31.png)
...
> 本文转载自：https://blog.csdn.net/bxdzyhx/article/details/118057390