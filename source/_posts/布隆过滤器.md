...
### 自定义的 BloomFilter
{% folding green close, 自定义的BloomFilter代码 %}
```c++
...
{% folding green close, Guava 中的 BloomFilter代码 %}
```html
<dependency>
...
> 原文转载自：[布隆过滤器，这一篇给你讲的明明白白](https://developer.aliyun.com/article/773205)

## 相关资料

[布隆过滤器（Bloom Filter）详解及应用](https://www.cnblogs.com/zhaodongge/p/15017574.html)